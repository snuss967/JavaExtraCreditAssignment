...
//Win screen will be displayed when we lose can probably use the same screen for both win and lose
public class Win extends JFrame {
	...
	public Win(int missedTimes, int guessedTimes, String word) {
	...
	private void intializeGUI() {
		...
		setLayout(box);
		// Game data display labels
		JLabel titleLabel = new JLabel("<html><div style='font-size: 40;'> You Win! </div></html>");
